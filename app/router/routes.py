...
from app.controllers.register_verify_phone import router as verify_phone_router
...
router.include_router(verify_phone_router, prefix="/register", tags=["register"])
